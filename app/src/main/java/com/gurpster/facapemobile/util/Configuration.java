...
//    }
    ...
    public static boolean saveString(String name, String s, Context context) {
        SharedPreferences prefs = context.getSharedPreferences("com.gurpster.facapemobile_preferences", 0);
        SharedPreferences.Editor editor = prefs.edit();
    ...
    public static boolean saveBoolean(String name, boolean b, Context context) {
        SharedPreferences prefs = context.getSharedPreferences("com.gurpster.facapemobile_preferences", 0);
        SharedPreferences.Editor editor = prefs.edit();
    ...
    public static boolean saveInt(String key, Integer data, Context context) {
        SharedPreferences prefs = context.getSharedPreferences("com.gurpster.facapemobile_preferences", 0);
        SharedPreferences.Editor editor = prefs.edit();
