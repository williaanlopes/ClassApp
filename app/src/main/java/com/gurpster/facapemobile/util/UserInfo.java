...
import com.gurpster.facapemobile.GradeFragment_;
...
//        return !DrawerActivity.acorn.isSameUserPass(getUsername(context), getPassword(context));
    ...
    public static void promptInputUserPassAndLogin(final DrawerActivity drawerActivity, final SwipeRefreshLayout swipeContainer, final GradeFragment_ gradeFragment){
